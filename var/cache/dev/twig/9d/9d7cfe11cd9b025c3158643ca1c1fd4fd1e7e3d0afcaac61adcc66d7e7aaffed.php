...
class __TwigTemplate_89c6d14fc999a1d494e95fb992796b0c7e022e16e7772deb6a6b9b0f97a24dab extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("gamesByCategory", ["category" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 8)]), "html", null, true);
            echo "\">";
            ...
            echo "</a>
                <a class=\"category-edit\" href=\"";
            // line 9
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("category_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 9)]), "html", null, true);
            echo "\">Modifier</a>
                <br>
        ";
...
";
    ...
    {
        return array (  120 => 14,  117 => 13,  111 => 12,  103 => 9,  96 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block titre %}<h1>Catégories</h1>{% endblock %}

{% block body %}

        {% for category in categories %}
                <a class=\"category-name\" href=\"{{ path('gamesByCategory', {'category': category.id}) }}\">{{ category.name }}</a>
                <a class=\"category-edit\" href=\"{{ path('category_edit', {'id': category.id}) }}\">Modifier</a>
                <br>
        {% else %}
        {% endfor %}

    <a class=\"new\" href=\"{{ path('category_new') }}\">Ajouter</a>
{% endblock %}
", "category/index.html.twig", "/var/www/vhosts/marin.etu.mmi-unistra.fr/nes.marin.etu.mmi-unistra.fr/templates/category/index.html.twig");
    }
}
