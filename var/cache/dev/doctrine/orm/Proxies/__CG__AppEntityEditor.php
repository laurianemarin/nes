 ...
 */
class Editor extends \App\Entity\Editor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Editor' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Editor' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Editor' . "\0" . 'games'];
        }
     ...
     * {@inheritDoc}
     */
    public function setName(string $name): \App\Entity\Editor
    {
     ...
     * {@inheritDoc}
     */
    public function addGame(\App\Entity\Game $game): \App\Entity\Editor
    {
     ...
     * {@inheritDoc}
     */
    public function removeGame(\App\Entity\Game $game): \App\Entity\Editor
    {
